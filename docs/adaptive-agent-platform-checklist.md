...
| 11 | Knowledge, bounded context and manifests | IN PROGRESS | Implement versioned candidate/accepted knowledge, bounded context selection, immutable manifests and file/source provenance. |
