...
| 10 | Task DAG, revisions, criteria and leases | IN PROGRESS | 10a `1adac4552`, 10b `2ce6564e8`, 10c `0618260a6`, 10d1 `a1f1b49a0` pushed. 10d2 consumes atomic dispatch and durable native generations in TUI/Chat launch/restore. Focused task/configured-worker tests, full Chat/session, backend build and changed-code lint PASS; full manager has exactly eight recorded baseline failures. Next: durable task intent and derived state; shared scheduler admission/recovery remains stages 16/23. |
