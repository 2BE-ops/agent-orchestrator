...
| 10 | Task DAG, revisions, criteria and leases | IN PROGRESS | 10a `1adac4552`, 10b `2ce6564e8`, 10c `0618260a6` pushed. Task service/API/CLI and lease/atomic-dispatch persistence tested. 10d1 durable native execution reservations (0157), restore/release race, restart, SQL fences and audit rollback tested; full domain/SQLite/store/CDC/build/lint PASS. Next 10d2: consume guards and atomic dispatch in native launch/restore. Shared scheduler admission remains stage 16; known Windows baseline gaps retained. |
