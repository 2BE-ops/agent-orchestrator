...
| [adaptive-agent-platform-design.md](adaptive-agent-platform-design.md) | Proposed adaptive platform: source audit, capability gaps, reuse boundaries and architecture (not implemented). |
