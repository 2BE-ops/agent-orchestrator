...
| `agent-manager` | Inspect Manager governance, routing inbox and audit | Exact governance/history; human-directed configuration and routing intent | [commands/agent-manager.md](commands/agent-manager.md) |
