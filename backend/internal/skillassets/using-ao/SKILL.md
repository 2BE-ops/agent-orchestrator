...
| `agent-manager` | Inspect project Manager configuration and audit | Reading exact governance; human-directed configuration changes | [commands/agent-manager.md](commands/agent-manager.md) |
