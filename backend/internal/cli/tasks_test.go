...
func TestTaskCLIHTTPBoundary(t *testing.T) {
	for _, tc := range []struct {
		...
		{[]string{"task", "evaluate", "task-1", "attempt-1", "--file", "-"}, http.MethodPost, "/api/v1/tasks/task-1/attempts/attempt-1/evaluations"},
		{[]string{"task", "evaluations", "task-1", "attempt-1"}, http.MethodGet, "/api/v1/tasks/task-1/attempts/attempt-1/evaluations"},
		{[]string{"task", "evaluation", "task-1", "attempt-1", "evaluation-1"}, http.MethodGet, "/api/v1/tasks/task-1/attempts/attempt-1/evaluations/evaluation-1"},
		{[]string{"task", "send-message", "worker-1", "--file", "-"}, http.MethodPost, "/api/v1/sessions/worker-1/task-messages"},
		{[]string{"task", "messages", "project"}, http.MethodGet, "/api/v1/projects/project/task-messages"},
		{[]string{"task", "message", "project", "message-1"}, http.MethodGet, "/api/v1/projects/project/task-messages/message-1"},
