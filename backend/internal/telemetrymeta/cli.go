...
var legacyActorlessUserCLICommands = map[string]struct{}{
	...
	"ao agent-manager registry-author":    {},
	"ao agent-manager registry-receipts":  {},
	"ao agent-manager registry-receipt":   {},
	...
	"ao orchestrator planning-outcomes": {},
	"ao orchestrator planning-summary":  {},
