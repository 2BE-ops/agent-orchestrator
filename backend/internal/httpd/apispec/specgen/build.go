...
func adaptiveTaskOperations() []operation {
	...
	for _, endpoint := range []struct {
		...
		{http.MethodPost, "/tasks/{taskId}/attempts/{attemptId}/evaluations", "evaluateTaskResult", "Collect stored independent evidence for an exact worker result", controllers.TaskEvaluateRequest{}, controllers.TaskEvaluateResponse{}, http.StatusOK, []any{controllers.AdaptiveTaskIDParam{}, controllers.AdaptiveTaskAttemptParam{}}},
